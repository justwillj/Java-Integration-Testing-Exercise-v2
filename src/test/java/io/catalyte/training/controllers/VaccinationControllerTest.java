...
public class VaccinationControllerTest {
  ...
  public void saveAllVaccinations() throws Exception {
    ...
    json.add("{\"innoculation\":\"Rabies\",\"date\":\"2021-10-17\",\"pet\":{\"id\":1,\"name\":\"Cletus\",\"breed\":\"Dog\",\"age\":6}}");
    json.add("{\"innoculation\":\"Worms\",\"date\":\"2021-04-10\",\"pet\":{\"id\":1,\"name\":\"Cletus\",\"breed\":\"Dog\",\"age\":6}}");
